...
import TicketManagement from "../../../components/admin/ticket/ticket-management";
...
const TicketPage: React.FC = () => {
  ...
  const toggleSidebar = () => {
    console.log(`Ticket Page - Toggling sidebar: ${isOpen} -> ${!isOpen}`);
    setIsOpen(!isOpen);
  };
  ...
  const getPageTitle = () => {
    ...
    return titles[activeItem] || "Unified Ticket Management";
  };
    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900 w-full">
      ...
      {isOpen && isMobile && (
        <div
          ...
          onClick={() => {
            console.log("Ticket Page - Overlay clicked - closing sidebar");
            setIsOpen(false);
          }}
        />
      )}
