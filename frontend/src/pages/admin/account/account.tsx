...
import MemberManagement from "../../../components/admin/account/account-management";
import { Toaster } from "react-hot-toast";

const AccountPage: React.FC = () => {
  const [activeItem, setActiveItem] = useState("member");
  ...
  const getPageTitle = () => {
    ...
    return titles[activeItem] || "Account Management";
  };
    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900 w-full">
      ...
      {isOpen && isMobile && (
        <div
          ...
          onClick={() => {
            console.log("Account Page - Overlay clicked - closing sidebar");
            setIsOpen(false);
          }}
        />
      )}
