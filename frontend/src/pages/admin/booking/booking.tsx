...
const BookingPage: React.FC = () => {
  ...
  const toggleSidebar = () => {
    console.log(`Booking Page - Toggling sidebar: ${isOpen} -> ${!isOpen}`);
    setIsOpen(!isOpen);
  };
  ...
  const getPageTitle = () => {
    ...
    return titles[activeItem] || "Booking Management";
  };
    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900 w-full">
      ...
      {isOpen && isMobile && (
        <div
          ...
          onClick={() => {
            console.log("Booking Page - Overlay clicked - closing sidebar");
            setIsOpen(false);
          }}
        />
      )}
