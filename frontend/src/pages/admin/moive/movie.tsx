...
import MovieManagement from "../../../components/admin/movie/moive-management";
...
const MoviePage: React.FC = () => {
  ...
  const toggleSidebar = () => {
    console.log(`Movie Page - Toggling sidebar: ${isOpen} -> ${!isOpen}`);
    setIsOpen(!isOpen);
  };
  ...
  const renderContent = () => {
    switch (activeItem) {
      case "movie": // [CHANGE THIS] - Switch case
    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900 w-full">
      ...
      {isOpen && isMobile && (
        <div
          ...
          onClick={() => {
            console.log("Movie Page - Overlay clicked - closing sidebar");
            setIsOpen(false);
          }}
        />
      )}
